...
# Adapter for local Ollama llama3.3:latest instance.
#
...
class Llama33LatestProvider(Tool):
    name = "llama3.3:latest_ollama"
    description = "Provides access to local Ollama-hosted llama3.3:latest models"
    input_schema = {
        "type": "object",
        "properties": {
            "messages": {
    ...
    def _check_ollama_connection(self) -> bool:
        ...
        try:
            ...
            print("3. Pull model: ollama pull llama3.3:latest")
            return False
