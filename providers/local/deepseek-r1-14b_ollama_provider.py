...
# Adapter for local Ollama deepseek-r1:14b instance.
#
...
class OllamaDeepSeek14bProvider(Tool):
    name = "deepseek-r1:14b_ollama"
    description = "Provides access to local Ollama-hosted deepseek-r1:14b models"
    input_schema = {
        "type": "object",
        "properties": {
            "messages": {
    ...
    def _check_ollama_connection(self) -> bool:
        ...
        try:
            ...
            print("3. Pull model: ollama pull deepseek-r1:14b")
            return False
