...
# Adapter for local Ollama olmo2:13b-1124-instruct-q8_0 instance.
#
...
class Olmo213b1124InstructQ80Provider(Tool):
    name = "olmo2:13b-1124-instruct-q8_0_ollama"
    description = "Provides access to local Ollama-hosted olmo2:13b-1124-instruct-q8_0 models"
    input_schema = {
        "type": "object",
        "properties": {
            "messages": {
    ...
    def _check_ollama_connection(self) -> bool:
        ...
        try:
            ...
            print("3. Pull model: ollama pull olmo2:13b-1124-instruct-q8_0")
            return False
