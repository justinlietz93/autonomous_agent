...
class MODEL_NAMEProvider(Tool):
    name = "MODEL_NAME_ollama"
    description = "Provides access to local Ollama-hosted MODEL_NAME models"
    input_schema = {
        "type": "object",
        "properties": {
            "messages": {
    ...
    def _check_ollama_connection(self) -> bool:
        ...
        try:
            ...
            print("3. Pull model: ollama pull MODEL_NAME")
            return False
