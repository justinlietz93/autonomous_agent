# deepseek-r1:14b-qwen-distill-fp16_ollama_provider.py
# Adapter for local Ollama deepseek-r1:14b-qwen-distill-fp16 instance.
#
...
class DeepSeekR114bQDFP16Provider(Tool):
    name = "deepseek-r1:14b-qwen-distill-fp16_ollama"
    description = "Provides access to local Ollama-hosted deepseek-r1:14b-qwen-distill-fp16 models"
    input_schema = {
        "type": "object",
        "properties": {
            "messages": {
    ...
    def _check_ollama_connection(self) -> bool:
        ...
        try:
            ...
            print("3. Pull model: ollama pull deepseek-r1:14b-qwen-distill-fp16")
            return False
