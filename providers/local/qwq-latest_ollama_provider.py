...
# Adapter for local Ollama qwq:latest instance.
#
...
class QwqLatestProvider(Tool):
    name = "qwq:latest_ollama"
    description = "Provides access to local Ollama-hosted qwq:latest models"
    input_schema = {
        "type": "object",
        "properties": {
            "messages": {
    ...
    def _check_ollama_connection(self) -> bool:
        ...
        try:
            ...
            print("3. Pull model: ollama pull qwq:latest")
            return False
