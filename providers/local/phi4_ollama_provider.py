# phi4:latest_ollama_provider.py
# Adapter for local Ollama phi4:latest instance.
#
...
class OllamaPhi4Provider(Tool):
    name = "phi4:latest_ollama"
    description = "Provides access to local Ollama-hosted phi4:latest models"
    input_schema = {
        "type": "object",
        "properties": {
            "messages": {
    ...
    def _check_ollama_connection(self) -> bool:
        ...
        try:
            ...
            print("3. Pull model: ollama pull phi4:latest")
            return False
