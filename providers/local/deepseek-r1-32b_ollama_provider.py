...
# Adapter for local Ollama deepseek-r1:32b instance.
#
...
class OllamaDeepSeekProvider(Tool):
    ...
    description = "Provides access to local Ollama-hosted deepseek-r1:32b models"
    input_schema = {
        "type": "object",
        "properties": {
            "messages": {
    ...
    def _check_ollama_connection(self) -> bool:
        ...
        try:
            ...
            print("3. Pull model: ollama pull deepseek-r1:32b")
            return False
