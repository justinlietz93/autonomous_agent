...
class gemma227b_ollamaProvider(Tool):
    name = "gemma2:27b_ollama"
    description = "Provides access to local Ollama-hosted gemma2:27b_ollama models"
    input_schema = {
        "type": "object",
        "properties": {
            "messages": {
    ...
    def _check_ollama_connection(self) -> bool:
        ...
        try:
            ...
            print("3. Pull model: ollama pull gemma2:27b_ollama")
            return False
