# command-r7b:7b-12-2024-fp16_ollama_provider.py
# Adapter for local Ollama command-r7b:7b-12-2024-fp16 instance.
#
...
class CommandR7bFp16Provider(Tool):
    name = "command-r7b:7b-12-2024-fp16_ollama"
    description = "Provides access to local Ollama-hosted command-r7b:7b-12-2024-fp16 models"
    input_schema = {
        "type": "object",
        "properties": {
            "messages": {
    ...
    def _check_ollama_connection(self) -> bool:
        ...
        try:
            ...
            print("3. Pull model: ollama pull command-r7b:7b-12-2024-fp16")
            return False
    ...
    def run(self, params: Dict[str, Any]) -> Dict[str, Any]:
        try:
            ...
            response = ollama.generate(
                model="command-r7b:7b-12-2024-fp16",
                prompt=prompt,
                stream=True
            )
            full_response = ""
