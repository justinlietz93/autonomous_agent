...
# Adapter for local Ollama dolphin3:8b-llama3.1-fp16 instance.
#
...
class Dolphin38bLlama31Fp16Provider(Tool):
    name = "dolphin3:8b-llama3.1-fp16_ollama"
    description = "Provides access to local Ollama-hosted dolphin3:8b-llama3.1-fp16 models"
    input_schema = {
        "type": "object",
        "properties": {
            "messages": {
    ...
    def _check_ollama_connection(self) -> bool:
        ...
        try:
            ...
            print("3. Pull model: ollama pull dolphin3:8b-llama3.1-fp16")
            return False
